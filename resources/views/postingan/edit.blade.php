...
@section('title', 'Edit Postingan - ' . $post->judul)
...
<div class="posting-container">
    ...
    <div class="posting-header">
        <h1 class="posting-title">Kelola postingan</h1>
        <p class="posting-subtitle">Perbaiki kata, kalimat, diksi yang berkemungkinan kurang tepat</p>
    </div>
            ...
            <form action="{{ route('postingan.update', $post->post_id) }}" method="POST" class="posting-form" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-input @error('judul') input-error @enderror" id="judul" name="judul"
                        placeholder="Masukkan judul yang menarik..." value="{{ old('judul', $post->judul) }}" maxlength="255"
                        required>
                    <div class="form-help">
            ...
            <ul class="tips-list">
                <li>
                    ...
                    <div>
                        ...
                        <p>Pilih gambar yang dengan ukuran 200px x 200px</p>
                    </div>
                </li>
                <li>
                    <span class="tips-check">✓</span>
...
<script>
    ...
    const isiInput = document.getElementById('isi_post');
